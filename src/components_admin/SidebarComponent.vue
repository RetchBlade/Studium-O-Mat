  ...
  <aside class="sidebar">
    ...
    <nav>
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="/admin/users">Benutzer</router-link>
        </li>
        <li class="nav-item">
          <router-link class="nav-link" to="/admin/fragen">Frage Pool</router-link>
        </li>
      </ul>
    </nav>
...
.logout-button {
  ...
  margin-bottom: 20px; /* Optional: Adds some space between the navigation and the button */
}
</style>
